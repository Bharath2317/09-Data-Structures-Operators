...
console.log(title, author[1], author[0], ISBN);
...
const players1Final = [...player1, 'Thiago', 'Cutinho', 'perisic'];
...
game.scored.forEach(game => console.log(game));

// const win = team1 > team2 || team1 < team2;
// console.log(`${win} will win th egame`);
